...
```json
{
    ...
    "examples": "Some specific examples or related information on how the TF questions are supposed to be generated",
    "number": "How many TF questions are required",
    "history": "Context of the conversation, especially previous questions"
}
```
...
```json
{
    ...
    "user_demand": "Some specific examples or related information on how the sequential questions are supposed to be generated",
    "history": "Context of the conversation, especially previous questions"
}
```
...
```json
{
    ...
    "examples": "Some specific examples or related information on how the quiz is supposed to be generated",
